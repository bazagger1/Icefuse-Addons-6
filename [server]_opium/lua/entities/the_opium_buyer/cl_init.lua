...
File Path:   addons/[server]_opium/lua/entities/the_opium_buyer/cl_init.lua
...
surface.CreateFont( "opium_font_17", {
	font = "Lato",
	size = 17,
	weight = 500,
	antialias = true,
...
surface.CreateFont( "opium_font_19", {
	font = "Lato",
	size = 28,
	weight = 500,
	antialias = true,
...
local ahshop3_icon1 = Material("materials/simple_opium/packer/icon.png")
...
function ENT:Draw()
	...
	cam.Start3D2D(self:GetPos()+self:GetUp()*79, Angle(0, AhEyes.y-90, 90), 0.08)
		...
		draw.SimpleText( "Peter Manister", "opium_font_19", -103, 23, Color( 168, 167, 168, 70 + main ), 0, 1 )
		draw.SimpleText( "Sell me your opium pack.", "opium_font_17", -120, 51, Color( 113, 111, 113, 70 + main ), 0, 1 )
